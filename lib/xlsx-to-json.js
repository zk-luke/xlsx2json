...
module.exports = {
  ...
  toJson: function (src, dest, config) {
    ...
    parseWorkbook(workbook, dest, headIndex, uglifyJson, excelName);
  }
};
 ...
 * @param       {[Number]} headIndex     index of head line.
 */
function parseWorkbook(workbook, dest, headIndex, uglifyJson, excelName) {

  console.log("xxxxx", dest);
  let dtsstring = "";
  ...
  console.log("xxxxx", dest,excelName);
